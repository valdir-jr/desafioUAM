...
if(salaAtual == 9 and interacoes < 7):
    print("\n---------------------------------------------------------------------------")
    ...
    print("| | |_ | / /\ \ | . ` |  __  | |  | | |  | |")
    print("| |__| |/ ____ \| |\  | |  | | |__| | |__| |")
    print(" \_____/_/    \_\_| \_|_|  |_|\____/ \____/ ")
    print("\n---------------------------------------------------------------------------")
else:
    print("\n---------------------------------------------------------------------------")
    print("__      ______   _____ ______        __  __  ____  _____  _____  ______ _    _ ")
    print("\ \    / / __ \ / ____|  ____       |  \/  |/ __ \|  __ \|  __ \|  ____| |  | |")
    print(" \ \  / / |  | | |    | |__         | \  / | |  | | |__) | |__) | |__  | |  | |")
    print("  \ \/ /| |  | | |    |  __|        | |\/| | |  | |  _  /|  _  /|  __| | |  | |")
    print("   \  / | |__| | |____| |____       | |  | | |__| | | \ \| | \ \| |____| |__| |")
    print("    \/   \____/ \_____|______       |_|  |_|\____/|_|  \_\_|  \_\______|\____/ ")
    print("\n---------------------------------------------------------------------------")